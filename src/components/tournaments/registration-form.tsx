          ...
          <div className="bg-slate-50 dark:bg-pitch-950/20 p-4 rounded-xl border border-slate-150 dark:border-white/5 space-y-2">
            <label className="block">
              ...
              {userProfile?.avatarUrl && (
                <div className="flex items-center gap-2 mb-3 bg-white dark:bg-pitch-950/40 p-2 rounded-xl border border-slate-200/50 dark:border-white/5 w-fit">
                  ...
                  />
                  <span className="text-[10px] text-slate-500 font-semibold pr-1">Current Picture</span>
                </div>
              )}
